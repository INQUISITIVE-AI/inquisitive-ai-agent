...
export const INQAI_TOKEN = {
  ...
  targetPrice:  parseFloat(process.env.NEXT_PUBLIC_TARGET_PRICE || '15'),
  presalePrice: parseFloat(process.env.NEXT_PUBLIC_PRESALE_PRICE || '8'),
  targetAPY:    parseFloat(process.env.NEXT_PUBLIC_TARGET_APY || '0.185'),
