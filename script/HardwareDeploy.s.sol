...
contract MainnetDeploy is Script {
    function run() external {
        // Use default Anvil account for testing, replace with hardware wallet for mainnet
...
// Hardware wallet deployment contract
contract HardwareWalletDeploy is Script {
    function run() external {
        // This will use your connected hardware wallet
        vm.startBroadcast();
