  ...
  return (
    <div>
      <Head>
        ...
        <meta name="description" content="Track INQAI token buybacks and burns in real-time. 20% of all performance fees permanently burned. 60% used for open-market buybacks." />
      </Head>
      <div style={{ minHeight: '100vh', background: '#07071a', color: '#fff', fontFamily: 'system-ui,-apple-system,sans-serif' }}>
        ...
        <div style={{ borderBottom: '1px solid rgba(255,255,255,0.06)', padding: '20px 28px', position: 'relative', zIndex: 1 }}>
          <div style={{ maxWidth: 1280, margin: '0 auto', display: 'flex', alignItems: 'baseline', gap: 12 }}>
            ...
            <span style={{ fontSize: 13, color: 'rgba(255,255,255,0.3)' }}>Live on-chain token supply · 60% buybacks · 20% permanently burned · 20% treasury</span>
          </div>
        </div>
