...
function buildPhase2Assets() {
  ...
  return [
    ...
    { tokenAddr: base58Decode('mSoLzYCxHdYgdzU16g5QSh3i5K3z3KZK7ytfqcJm7So'), chainId: 7565164n, receiver: solBuf, weightBps: 50n,   symbol: 'mSOL'    },
    ...
    { tokenAddr: evmBytes('0xa8AEA66B361a8d53e8865c62D142167Af28Af058'),         chainId: 56n,      receiver: bscBuf, weightBps: 10n,   symbol: 'CNGN'    },
