...
export const ASSET_REGISTRY: RegistryEntry[] = [
  ...
  { symbol:'NIGHT',   cgId:'midnight-2',              name:'Midnight',                         category:'privacy',      yieldable:false, stakeable:false, lendable:false },
  ...
  { symbol:'CNGN',    cgId:'cngn',                    name:'Compliant Naira',                  category:'stablecoin',   yieldable:true,  stakeable:false, lendable:true  },
...
export const PORTFOLIO_WEIGHTS: Record<string, number> = {
  ...
  USDC:3, PAXG:1.5, ONDO:1, XLM:0.5, LTC:0.5, BCH:0.5, HBAR:0.5, ZEC:0.25, XMR:0.25, ETC:0.5, XTZ:0.25, CHZ:0.25, HNT:0.25, VET:0.25, QNT:0.25, ALGO:0.25, FIL:0.25, AR:0.25, XDC:0.1, ZRO:0.25, ATOM:0.25, DBR:0.1, ACH:0.1, EOS:0.1, HONEY:0.1, XSGD:0.1, SOIL:0.1, BRZ:0.1, JPYC:0.1, CNGN:0.1, JITOSOL:0.5, JUPSOL:0.5, INF:0.5, CC:0.1, NIGHT:0.1, XCN:0.1,
};
