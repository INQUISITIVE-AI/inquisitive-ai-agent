            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
              ...
              <div style={{ background: 'rgba(13,13,32,0.8)', border: '1px solid rgba(255,255,255,0.05)', borderRadius: 20, padding: '24px', backdropFilter: 'blur(12px)' }}>
                ...
                {[
                  ...
                  { n: '02', t: 'ETH Deployed Across 66 Assets', d: 'Your ETH payment is received by the vault. The AI keeper automatically triggers performUpkeep() — diversifying across 26 Uniswap V3 swaps, 13 deBridge cross-chain bridges (including TRON for TRX), and 25 Lido stETH positions.' },
