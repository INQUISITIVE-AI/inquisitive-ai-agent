...
export default function BuyPage() {
  ...
  const handleBuy = async () => {
    ...
    try {
      ...
      // Chainlink/keeper calls performUpkeep() to deploy across all 66 assets.
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
              ...
              <div style={{ background: 'rgba(17,17,19,0.8)', border: '1px solid rgba(255,255,255,0.05)', borderRadius: 20, padding: '24px', backdropFilter: 'blur(12px)' }}>
                ...
                {[
                  ...
                  { n: '02', t: 'ETH Deployed Across 66 Assets', d: 'Your ETH payment is received by the vault. Chainlink Automation triggers performUpkeep() when conditions are met — diversifying across 26 Uniswap V3 swaps, 13 deBridge cross-chain bridges (including TRON for TRX), and 25 Lido stETH positions.' },
                  { n: '03', t: 'Proportional Asset-Backed Ownership', d: 'Each INQAI token represents proportional ownership in the underlying 66-asset portfolio. Live NAV is calculated from native CoinGecko prices — zero proxy disconnect.' },
